        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center text-center mb-24">
            <div className="w-full lg:w-6/12 px-4">
              <h2 className="text-4xl font-semibold">Contact us Information</h2>
            </div>
          </div>
            ...
            <div className="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                <div className="pt-6 text-center">
                  ...
                  <h6 className="text-3xl font-semibold mt-4 mb-2">Phone</h6>
                  <p>+923111590111</p>
                </div>
              </div>
            </div>
            <div className="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                <div className="pt-6 text-center">
                  ...
                  <h6 className="text-3xl font-semibold mt-4 mb-2">Email</h6>
                  <p>dreamhousingscheme@gmail.com</p>
                </div>
              </div>
            </div>
            <div className="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                <div className="pt-6 text-center">
                  ...
                  <h6 className="text-3xl font-semibold mt-4 mb-2">
                    Head Office
                  </h6>
                  <p>
