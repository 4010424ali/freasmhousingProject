              ...
              <div className="relative bg-white">
                ...
                <div className="pt-20 px-6 sm:px-12">
                  <p className="text-gray-600 text-base pb-6">
                    ...
                    awesome and really professional. I enjoyed the services they
                    offered. Their design is impeccable.
                  </p>
                  <p className="text-gray-600 text-base pb-8">
                    ...
                    services. Excellent communication and I always feel that I
                    am their first priority.
                  </p>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center pb-12">
                      <div className="h-12 w-12">
            ...
            <figure className="hidden">
              <div className="relative bg-white">
                ...
                <div className="pt-20 px-6 sm:px-12">
                  ...
                  <p className="text-gray-600 text-base pb-8">
                    Undoubtedly working with them was just like playing. It was
                    so easy editing your content, so fast getting perfect
                    results and so easy customizing based on your own
